#include "mnist.h"
std::vector<std::pair<int,std::vector<int>>> mnist::read_MNIST_data(int number_of_images, int number_of_features,std::string filename)
{
    ...
    if (file.is_open()){
        ...
        for(int i = 0; i < number_of_images; ++i){
            ...
            vec.push_back(std::make_pair(i,tp));
        }
    }
    return vec;
}
