#include "mnist.h"
std::vector<std::pair<std::string,std::vector<double>>> mnist::read_MNIST_data(int number_of_images, int number_of_features,std::string filename)
{
    std::vector<std::pair<std::string,std::vector<double>>> vec;
    std::ifstream file;
...
std::vector<double> mnist::read_MNIST_labels(int number_of_images,std::string filename)
{
