...
using intersectBFunc=std::function<std::pair<std::vector<int>,std::map<std::string,std::vector<std::string>>>(std::vector<bloom_filter>)>;
...
int main()
{
    ...
    std::cout<<"同态加密结果已写入cipherB.txt"<<std::endl;
    freopen("cipherB.txt","w",stdout);
